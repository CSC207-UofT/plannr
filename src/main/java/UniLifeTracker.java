...
public class UniLifeTracker {
    public static void main (String[] args) {
        ...
        // Prompt user for their name + university they attend
        ...
        while (stay) {
            ...
            if (userAction == 1) { //add event
                ...
                System.out.print("Enter the end date of the event: "); //let user know if there is a conflict
                // How to get the date

                //if date == date of an event in user's event list, print there's a conflict

                System.out.print("Enter the priority of the event (0 = high, 1 = mid, 2 = low): ");
                int priority = scan.nextInt();
                System.out.print("Enter the name of the course this deadline is for: ");
